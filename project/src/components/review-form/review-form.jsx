...
function ReviewForm() {
  ...
  return (
    ...
    >
      ...
      <div className="reviews__rating-form form__rating" onChange={({ target }) => {
      ...
      <textarea className="reviews__textarea form__textarea" id="review" name="review" placeholder="Tell how was your stay, what you like and what can be improved" onChange={({ target }) => {
        const value = target.value;
        setComment(value);
      }}
      >
